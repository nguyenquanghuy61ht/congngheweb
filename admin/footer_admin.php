...
<script type="text/javascript" src="http://localhost:7855/BTL/assets/js/myscript.js"></script>
<script type="text/javascript" src="http://localhost:7855/BTL/index2.php"></script>
<script type="text/javascript" src="http://localhost:7855/BTL/admin/js/ajax.js">
</script>
<script type="text/javascript" src="http://localhost:7855/BTL/admin/js/prosecer_delete.js"></script>
