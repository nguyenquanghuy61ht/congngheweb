            ...
            <div class="row">
                ...
                <div class="col-md-10 col-sm-12  ">
                    <div class="row " id="tab-dieuhuong">
                        ...
                        ?>
                                <div class="col-md-3 col-sm-6  mb-3 border  p-2">
                                    <div class="">
                                    <div width="80px" height="100px" class="p-2" ><img class="img-thumbnail" src="<?php echo './' . $row['avatar_mh'];  ?>" alt=""></div>
                                        ...
                                        <a href="page-subject/LT_php.php" class="btn btn-primary m-b-1">vào học</a>
                                    </div>
                                </div>
