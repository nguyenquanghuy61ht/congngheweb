            ...
            <div class="row ">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <?php
                                        $sql_diem = "SELECT file_diem,lop.tenlop from diem,lop where diem.malop=lop.malop and diem.mamh=15 ";
                ...
                <div class="col-md-9 position-relative ">
                    ...
                    <div class=" position-absolute top-0 start-0 end-0 bottom-0 about-page hide mb-4 ">
                        ...
                        <?php
                        $sql_mes = "SELECT noi_dung,link,date_mes From thongbao where  mamh=15";
