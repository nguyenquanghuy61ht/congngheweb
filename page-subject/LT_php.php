...
<body>
    ...
    <div class="wrapper mt-4 ">
            ...
            <div class="row ">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <?php
                                    $sql_diem = "SELECT file_diem,lop.tenlop from diem,lop where diem.malop=lop.malop and diem.mamh=14 ";
                ...
                <div class="col-md-9 position-relative">
                    ...
                    <div class=" position-absolute top-0 start-0 end-0 bottom-0 about-page hide mb-4 ">
                        ...
                        <?php
                        $sql_mes = "SELECT noi_dung,link,date_mes From thongbao where  mamh=14";
        ...
        <div class="container mt-1 border-top border-dark">
            ...
            <?php
            $sql_select = "SELECT tensv,content,date_com from comment,sinhvien where mamh=14  and comment.masv=sinhvien.masv ";
