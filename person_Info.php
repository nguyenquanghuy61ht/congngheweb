...
<div class="col-md-4 col-sm-4 mt-2 border-end">
    ...
    <p class="m-0">Trưởng bộ môn</p>
    <p class="m-0">Bộ môn Tin học và Kỹ thuật tính toán, Khoa CNTT, C1 ĐH Thủy lợi, Hà nội</p>
    <p class="m-0">Đại học Thủy Lợi</p>
    <p class="m-0">phuc123@tlu.edu.vn</p>
</div>
