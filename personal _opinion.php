...
<div class="container " >
    <div class="row " class="boder boder-primary">
        <div class="col-md-6">
            ...
            <label class="form-label" for="textAreaExample2">ý kiến cá nhân  </label>    
            ...
            <a href="http://localhost:7855/BTL/admin/"><button type="button" class="btn btn-warning mt-3 ">nêu ý kiến  </button></a> 
        </div>
